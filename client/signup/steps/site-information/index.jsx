...
class SiteInformation extends Component {
	...
	handleInputChange = ( { target: { name, value } } ) => {
		...
		if ( name === 'name' ) {
			this.setState( { needToQueryDomains: true } );
			this.debouncedSetSiteTitle( value );
		}
	};
...
export default connect(
	...
	( dispatch, ownProps ) => ( {
		setSiteTitle: title => dispatch( setSiteTitle( title ) ),
		submitStep: ( { name, address, email, phone, siteUrl, suggestion } ) => {
